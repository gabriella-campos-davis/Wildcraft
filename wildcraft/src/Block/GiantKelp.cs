...
namespace wildcraft
{
    public class GiantKelp : BlockPlant
    {
        ...
        void PlaceKelp(IBlockAccessor blockAccessor, BlockPos pos, LCGRandom worldGenRand, int depth)
        {
            ...
            Block middleBlock = blockAccessor.GetBlock(new AssetLocation("wildcraft:giantkelp-middle"));
            Block topBlock = blockAccessor.GetBlock(new AssetLocation("wildcraft:giantkelp-top"));
