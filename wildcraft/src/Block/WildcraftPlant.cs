...
namespace wildcraft
{
    public class WildcraftPlant : BlockPlant
    {
        ...
        public bool canDamage = WildcraftConfig.Current.plantsCanDamage;
        public bool canPoison = WildcraftConfig.Current.plantsCanPoison;
